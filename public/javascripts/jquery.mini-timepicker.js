(function($) {
	...
	var methods =  {
	    ...
	    if ($(document).data("loaded_time_hooks")) { return; } // we use jQuery.live() we don't need to load twice!
        ...
        this.each(function() {
            ...
            if (! ($this.is('input') && $this.attr("type")=='text' ) ) { return ; }
	    
	    if (! $this.hasClass('base_input') ) {  methods.draw_dupe_inputs($this); }
